...
node {
    properties([
        parameters([
         string(defaultValue: 'demo-performance', description: 'Name of your Keptn Project for Performance as a Self-Service', name: 'Project', trim: false), 
         ...
         string(defaultValue: 'frontend', description: 'Servicename used to keep SLIs, SLOs, test files ...', name: 'Service', trim: false),
