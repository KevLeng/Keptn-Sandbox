...
node {
    ...
    stage('Initialize Keptn') {
        ...
        keptn.downloadFile("https://raw.githubusercontent.com/keptn-sandbox/keptn-in-a-box/master/resources/jenkins/pipelines/keptn/dynatrace/customer.dynatrace.conf.yaml", 'keptn/dynatrace/dynatrace.conf.yaml')
