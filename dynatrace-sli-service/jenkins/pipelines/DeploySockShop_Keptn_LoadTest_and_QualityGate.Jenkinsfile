            ...
            steps{
                container('kubectl'){
                    ...
                    script{
						...
						keptn.keptnAddResources('jenkins/keptn/dynatrace.conf.yaml','dynatrace/dynatrace.conf.yaml')
						keptn.keptnAddResources('jenkins/keptn/sli_basic.yaml','dynatrace/sli.yaml')
						keptn.keptnAddResources('jenkins/keptn/slo_basic.yaml','slo.yaml')

						archiveArtifacts artifacts:'jenkins/keptn/**/*.*'
						
						echo 'Initialize Keptn...done.'
