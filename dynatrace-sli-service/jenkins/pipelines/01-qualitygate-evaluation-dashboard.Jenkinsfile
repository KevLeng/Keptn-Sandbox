...
node {
    properties([
        parameters([
         ...
         string(defaultValue: 'frontend', description: 'Name of the Tag for identifyting the service to validate the SLIs and SLOs', name: 'Service', trim: false),
    ...
    stage('Initialize Keptn') {
		keptn.downloadFile("https://raw.githubusercontent.com/KevLeng/Keptn-Sandbox/master/dynatrace-sli-service/jenkins/dynatraceconfig/customer.dashboard.dynatrace.conf.yaml", 'keptn/dynatrace/dynatrace.conf.yaml')
